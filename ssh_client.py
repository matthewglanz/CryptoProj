...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
  ...
  #Receive the random RSA y1, y2 
  RSAy1 = int(sock.recv(1024).decode('utf-8'))
  RSAy2 = int(sock.recv(1024).decode('utf-8'))

  #Decrypt y1 and y2 for the key
  ...
  secretKey = RSAy2 ^ msgrandRSAhash
